        ...
        <div class="p-4 mx-auto max-w-screen-md font-light">
          <div id="blog" class="zzzhidden">
            ...
            <p class="mt-3">
              ...
              someone updates a record on the database (which gets sent to the US) immediately before you read it in Australia, depending on
            ...
            <p class="mt-3">
              ...
              one account and credits another for the same amount, you will likely want to use strong consistency and ACID transactions.  
            ...
            <p class="mt-3">
              ...
              <svg class="inline w-6 mr-3" viewBox="0 0 256 341" version="1.1" preserveAspectRatio="xMidYMid">
                ...
                Upstash Redis</h3>
              <p class="mt-3">
                Upstash takes the well known in-memory Redis database a step further with a durable Redis compatible global database. 
                ...
                Sydney and Sao Paulo).  N.b. this would be an expensive setup for a high volume application.
              </p>
              <h3 class="mt-3 text-xl font-bold">
          ...
          <p class="mt-3">
            <span class="font-bold text-red-500 underline">Important:</span> Please read the analysis and conclusions on each DB below to understand
          ...
          <div class="mt-8" id="FaunaAnalysis">
            ...
            <p class="mt-3">
              ...
              Fauna has some great customer service with good response times and helpful answers.
            </p>
            <p class="mt-3">
            ...
            <p class="mt-3">
              ...
              edge platform and as the GraphQL API is pure http based there are no libraries to worry about.  Alternatively, using Airbyte you 
              can extract your data from Fauna and move it elsewhere.
            </p>
            <p class="mt-3">
              <span class="font-bold">Pricing: </span>There are 7 metrics Fauna uses in its pricing model.  Their entry level plan
              gets you $25 worth of services each month which equates to a maximum of 54 million reads, 11 million writes or 25GB 
              of storage.  Costs appear to be middle of the road.
            </p>
          </div>
          <h3 class="mt-8 text-xl font-bold">
                <svg class="inline mr-3 w-8" viewBox="-16.5 0 289 289" preserveAspectRatio="xMidYMid">
          ...
          <div class="mt-8" id="DynamoDBAnalysis">
            ...
            <p class="mt-3">
              ...
              replica region.  Then, in front of the compute layer is another service like Route53 which can route the request to the closest
            ...
            <p class="mt-3">
              <span class="font-bold">Pricing: </span>DynamoDB costs can be a challenge to compute.  In the general, reads and writes
          ...
          <div class="mt-8" id="UpstashRedisAnalysis">
            ...
            <p class="mt-3">
              ...
              the other databases (N.B. remember that Upstash has 8 read regions, while the others have 3 at most).
            </p>
            <p class="mt-3">
            ...
            <p class="mt-3">
              <span class="font-bold">Pricing: </span>Upstash provides the simplest pricing model of the databases tested.  With its
          ...
          <div class="mt-8" id="PlanetScaleAnalysis">
            ...
            <p class="mt-3">
              ...
              must manage the connections yourself in the client (e.g. decide which region to connect to), unlike other providers who route you to the 
            ...
            <p class="mt-3">
              ...
              is via their javascript driver which you can use via a npm specifier or CDN (unpkg, esh.sh, etc).  Though MySQL compatible, 
              there are no foreign key constraints.  Such constraints need to be implemented in application logic instead. Finally, when on the
            ...
            <p class="mt-3">
              ...
              &nbsp;<a href="https://dev.to/harshhhdev/planetscale-vitess-legacy-sharded-databases-and-referential-integrity-ikp">Transactions are
              not ACID compliant</a>.  Strongly consistent reads are not supported.
            </p>
            <p class="mt-3">
              <span class="font-bold">Features/Flexibility: </span>PlanetScale's standout feature is its schema management capabilities.
          ...
          <p class="mt-3">
            ...
            improve in the future. Being limited to GraphQL API only (i.e. and not FaunaQL) on Deploy is also a negative.
          </p>
          <p class="mt-3">
            ...
            frustrating, though I expect this to improve dramatically once npm specifiers are supported.
          </p>
          <p class="mt-3">
          ...
          <p class="mt-3">
            ...
            and runs counter to the serverless concept. Admittedly, few projects will need to undertake this. The schema management 
            features are impressive and it's the only database in this
            experiment which can best handle relational data (n.b. Fauna also handles relational data, it would be interesting to pit
          ...
          <p class="mt-3">
            ...
            for use on Deploy, unless vendor lock-in is a major consideration.
          </p>
          <p class="mt-3">
          ...
          <p class="mt-8 italic">
            ...
            you want to share please reach out in the <a href="https://github.com/cknight/kvSpeedCheck/discussions">project discussions</a>.
            Code for the experiment may also be found in the <a href="https://github.com/cknight/kvSpeedCheck">github repo</a>.
          </p>
