      ...
      <body class="bg-[#202020] text-gray-100 w-full h-full font-['proxima-nova, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, sans-serif']">
        ...
        <div class="p-4 mx-auto max-w-screen-md">
          ...
          <p class="mt-3">
            ...
            manage this complexity for you. DynamoDB's consistency model and pricing are complex and difficult to understand.  Running a local
            DynamoDB is not simple either.

            Planetscale employs database sleeping for free tier customers after 7 days inactivity.  The database must be woken up via the
