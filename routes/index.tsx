      ...
      <body class="bg-[#202020] text-gray-100 w-full h-full font-['proxima-nova, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, sans-serif']">
        ...
        <div class="p-4 mx-auto max-w-screen-md font-light">
          <div id="blog" class="zzzhidden">
            ...
            <p class="mb-8 mt-5">By Chris Knight, 20/05/2023</p>
            <p class="italic">
            ...
            <ul class="list-decimal ml-7 mt-3">
              ...
              <li><a href="#understanding_database_consistency">Understanding database consistency</a></li>
              <li><a href="#global_databases_for_deploy">Global databases for Deploy</a></li>
              <li><a href="#latency_experiment">Latency experiment</a></li>
              <li><a href="#db_latencies_from_your_location">DB latencies from your location</a></li>
              <li><a href="#db_latencies_from_all_over_the_world">DB latencies from all over the world</a></li>
            ...
            <p class="mt-3">
              ...
              The next evolution in this journey are globally distributed (sometimes referred to as edge) databases, hosted in multiple datacentres
            ...
            <p class="mt-3">
              ...
              <ul class="list-disc ml-7 mt-3">
                <li>database reads which guarantee the most up to date data (referred to as strong consistency reads), but may be slower as these 
                  must be read from the primary region</li>
                <li>reads which are faster as they can be read from the database region closest to the server, but may return stale data (referred 
                  to as eventual consistency reads)</li>
              </ul>
              ...
              a significant amount of latency by not waiting for the writes to propagate to the closest region.  This is the approach that Deno KV takes. 
            </p>
            ...
            <p class="mt-3">
              Let's imagine you are located in Australia and the primary region of the database in the US. If someone updates a record on 
              the database immediately before you read it, depending on your consistency model, you may get the old value (eventual 
              consistency) or the new value (strong consistency).
            </p>
            <p class="mt-3">
              ...
              one account and credits another for the same amount, you will likely want to use strong consistency.  
            ...
            <h2 class="text-2xl font-bold">Global databases for Deploy</h2>
            <p class="mt-3">
              Running applications on Deno Deploy means serving requests from locations around the globe, from a location closest to the user.
              Ideally, the database would be located closed to the server so that latency between the server and database is minimised.  Therefore
              an ideal database for Deno Deploy would be globally distributed with data replicated in multiple regions to decrease latency.
              In this post, we'll experiment with the following serverless databases which all offer multi-region replication:
            </p>
              ...
              <p class="mt-3">
                ...
                level you want for your reads. It is built on top of the open source FoundationDB (used by Apple's 
                iCloud) and there is no configuration or setup.  Data is replicated to at least 6 datacentres across 3 regions (US, Europe 
                and Asia).  Access is via a custom but simple API layer.  ACID transactions are supported globally and offer strict serializability,
                the strongest level of consistency possible.
              </p>
              <h3 class="mt-3 text-xl font-bold">
              ...
              <p class="mt-3">
                ...
                setup, you can enable "global tables" which creates identical tables in additional regions (in as many regions as you like). 
              ...
              <svg class="inline w-6 mr-3" viewBox="0 0 256 341" version="1.1" preserveAspectRatio="xMidYMid">
                ...
                Upstash Redis</h3>
              <p class="mt-3">
                Upstash provides a data platform including a durable Redis compatible global database. Access is via Redis APIs.  It is the only database
                in this experiment which offers per request pricing and which scales to zero price if not used (pro and enterprise plans allow for 
                fixed monthly usage cost as well).  Upstash Redis only offers eventual consistency.  For this experiment, a primary region of N. Virginia
                was configured with replicas setup in all available replica regions (California, Oregon, Frankfurt, Ireland, Singapore, Sydney and Sao Paulo).
              </p>
              <h3 class="mt-3 text-xl font-bold">
              <svg class="inline mr-3 w-8 bg-white p-1" viewBox="0 0 256 256"preserveAspectRatio="xMidYMid">
                ...
                PlanetScale</h3>
              <p class="mt-3">
                PlanetScale offers a serverless MySQL-compatible database built on top of Vitess and is the only true relational database of the experiment.  
                It offers 11 AWS regions with 4 GCP regions in Beta. For this experiment, a primary region of N. Virginia was selected.  Additional replica 
              ...
              <p class="mt-3">
                Though serverless, PlanetScale isn't necessarily hands off as when your database starts scaling you may need to intervene
                and apply sharding, which can be complicated.
              </p>
                ...
                <table class="min-w-full text-left text-sm font-light bg-[#202020]">
                  ...
                  <tbody>
                    ...
                    <tr class="border-b">
                      ...
                      <td>Eventual</td>
                      <td>Redis API</td>
                      <td>Serializable transactions (undocumented if ACID compliant)</td>
                    </tr>
                    <tr class="border-b">
          ...
          <p class="mt-3">
            ...
            databases, all accessed from Deno Deploy?
          </p>
          <p class="mt-3">
          ...
          <p class="mt-3">
            <span class="font-bold text-red-500">Important:</span> Please read the analysis and conclusions on each DB below to understand
            ...
            setups, use cases, replica regions, configuration, etc.  The results are meant to give you a general idea
            of the performance of each DB for a very simple use case, but should not be used to make a final decision on which DB to use.  
            You should always do your own research, testing and benchmarking to determine which DB is best for your use case.
          </p>

          <div id="db_latencies_from_your_location">&nbsp;</div>
          <h2 class="text-2xl font-bold">DB latencies from your location</h2>
          <p class="mt-3">
          ...
          <h2 class="text-2xl font-bold">DB latencies from all over the world</h2>
          <p class="mt-3">
          ...
          <div class="mt-4" id="DenoKVAnalysis">
            ...
            <p class="mt-3">
              ...
              on FoundationDB, however locally you are using a SQLite database.  The difference is transparent as the API doesn't change.  
              There's nothing you need to do between development and production setup.  As a beta product with few features, 
              manually effort is needed to populate data into KV stores be in on another dev machine or Deploy branch build.  Manual work
            ...
            <p class="mt-3">
              ...
              key-value database, as well as good ability to do range searches.
            </p>
            <p class="mt-3">
            ...
            <p class="mt-3">
              ...
              distributed database, KV is only  available in Deno Deploy.  While you can deploy your Deno app yourself to 
              any server and use the KV API with a local SQLite database, you will not get global distribution of your data.  Deno 
              also has a custom API meaning you cannot simply swap out KV for another database if in the future you migrate off of 
              Deploy or away from KV.  That said, the API is very simple so migrations may not be overly difficult.
            </p>
          </div>
          <h3 class="mt-3 text-xl font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42.3 47" class="w-8 inline mr-3"><path style="fill:#813eef" d="M32.9 9.9c-2.9 1-4.3 2.7-5.3 5.4-.2.7-.9 1.5-1.6 2.1l2.4 2.6-7.6-5.3L0 0s1.5 9.8 2 13.4c.4 2.5 1 3.7 3 4.8l.8.4 3.4 1.8-2-1.1 9.4 5.2-.1.1L6.4 20c.5 1.8 1.6 5.4 2 7 .5 1.7 1 2.3 2.7 2.9l3 1.1 1.9-.7-2.4 1.6L1.7 47c7.9-7.4 14.6-10 19.5-12.1 6.3-2.7 10-4.5 12.5-10.7 1.8-4.4 3.1-10 4.9-12.2l3.7-4.7c0-.1-7.6 2-9.4 2.6z"></path></svg>
          ...
          <div class="mt-8" id="FaunaAnalysis">
            ...
            <p class="mt-3">
              ...
              and there is a lot of new terminology to learn.  There are few examples of using Fauna with Deno and even the guide on 
              Deno Deploy documentation leaves a lot to be desired.
            </p>
            <p class="mt-3">
            ...
            <p class="mt-3">
              ...
              edge platform and as the GraphQL API is pure http based there are no libraries to worry about.
            </p>
          </div>
          ...
          <div class="mt-4" id="DynamoDBAnalysis">
            <table class="text-left bg-[#202020]">
              <thead class="border-b font-medium">
                <tr>
                  <th class="sticky w-56 left-0 z-10 px-6 py-3 bg-[#202c2c]">Metric</th>
            ...
            <p class="mt-3">
              ...
              even the Deno Deploy example is <a href="https://github.com/denoland/deploy_feedback/issues/390">broken and incomplete</a>.
            </p>
            <p class="mt-3">
              <span class="font-bold">Local development: </span>AWS provide an executable jar, maven dependency (both Java) or Docker 
              image for local development. Data files can be specified for pre-population and sharing.
            </p>
            <p class="mt-3">
              ...
              including which is your primary region is great flexibility.  However, there are a number of caveats.  Every new region added
              adds new costs to your usage, which may quickly become much more expensive than other solutions.  Additionally, using global 
              tables introduces a weaker consistency model.
              ...
              logic in the client yourself or place a compute layer in front of DynamoDB in each replica region.  Then, in front of the
              compute layer is another service like Route53 which can route the request to the closest compute layer.  Considerations like
              region outages must either be explicity coded for in the client or health checks configured in Route53 to route around the outage.
            </p>
            <p class="mt-3">
            ...
            <p class="mt-3">
              ...
              comes from the first use of the API which incurred a ~400ms delay, effectively a cold start and something not encountered in any 
            ...
            <p class="mt-3">
              ...
              you get strong consistency writes and optionally reads too (default is eventual consistency reads).  However, if using global tables, you
              a specified "strong consistent read" will only be strongly consistent for writes within the same region.  This means global tables
              are effectively eventually consistent.  Cross region transactions are not ACID compliant leading to potential data loss if 
              concurrent writes to the same data occur in multiple regions.
            </p>
            <p class="mt-3">
            ...
            <p class="mt-3">
              ...
              edge server (e.g. Cloudflare) is not as DynamoDB will work with any provider through it's http interface.
            </p>
          </div>
          ...
          <div class="mt-4" id="UpstashRedisAnalysis">
            <table class="text-left bg-[#202020]">
              <thead class="border-b font-medium">
                <tr>
                  <th class="sticky w-56 left-0 z-10 px-6 py-3 bg-[#202c2c]">Metric</th>
            ...
            <p class="mt-3">
              ...
              other options.  Connection is maintained through a REST URL and token.  Quick start guides are available for AWS Lambda,
            ...
            <p class="mt-3">
              <span class="font-bold">Local development: </span>Local development is achieved through a community supported project
                  called Serverless Redis HTTP (SRH). While Upstash offer support to the maintenance they do not maintain this project
                  and one concern would be the single maintainer of the project.  SRH also has some differences to Upstash Redis.
                  Some instructions are provided for running SRH in docker, but there are gaps leaving you to fill in the blanks.
            ...
            <p class="mt-3">
              ...
              Deploy, only <a href="https://docs.upstash.com/redis/quickstarts/deno-deploy">a few imports</a> and environment variables are needed.
            </p>
            <p class="mt-3">
              ...
              the other databases (NOTE: remember that Upstash has 8 read regions, while the others have 3 at most).
            </p>
            <p class="mt-3">
              <span class="font-bold">Consistency: </span>A weak point of Upstash Redis is consistency. Their consistency model is eventual
              consistency.  Additionally transactions are not ACID compliant.
            </p>
            <p class="mt-3">
            ...
            <p class="mt-3">
              <span class="font-bold">Vendor independence: </span>Like the other DBs besides KV, Upstash Redis is portable and you can
              ...
              installation.  One challenge to that is there are not many (any?) offerings of globally distributed durable Redis.
            </p>
          </div>
          <h3 class="mt-3 text-xl font-bold">
              <svg class="inline mr-3 w-8 bg-white p-1" viewBox="0 0 256 256"preserveAspectRatio="xMidYMid">
          ...
          <div class="mt-4" id="PlanetScaleAnalysis">
            <table class="text-left bg-[#202020]">
              <thead class="border-b font-medium">
                <tr>
                  <th class="sticky w-56 left-0 z-10 px-6 py-3 bg-[#202c2c]">Metric</th>
            ...
            <p class="mt-3">
              ...
              regions, you can also enable one or more read-only replica regions.  One downside to PlanetScale's global setup is that you
              must manage the connections yourself (e.g. decide which region to connect to), unlike other providers who route you to the 
            ...
            <p class="mt-3">
              ...
              manual sharding (partioning your data across multiple databases to spread the load) is required if your database
              ...
              is via their javascript driver which you can use via a npm specifier or CDN (unpkg, esh.sh, etc).  Finally, when on the
              free tier, your database will be put to sleep after 7 days of inactivity.  You must manually wake it up via the console.
            </p>
            <p class="mt-3">
              ...
              surprisingly slow, slowest of all databases in the experiment.  
            </p>
            <p class="mt-3">
              <span class="font-bold">Consistency: </span>Transactions are not ACID compliant.
            </p>
            <p class="mt-3">
              <span class="font-bold">Features/Flexibility: </span>
            </p>
            <p class="mt-3">
              <span class="font-bold">Vendor independence: </span>
            </p>
          </div>
